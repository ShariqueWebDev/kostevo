              ...
              <div className=" leading-[1.05] max-lg:w-full max-lg:mt-8 ">
                <div className="">
                  ...
                  <p className="text-gray-600 content-all text-sm">
                    Our Flanges are produced following standards like ASME
                    B16.5, ASME B16.47, and DIN EN 1092-1, ensuring high-quality
                    connections in piping systems. Sizes vary from 1/2 inch to
                    24 inches, and materials include stainless steel, carbon
                    steel, and alloy steel in compliance with ASTM A105, ASTM
                    A182, and ASTM A350. These flanges are ideal for connecting
                    pipelines and equipment in petrochemical industries, power
                    plants, and offshore platforms, offering reliable
                    performance under varying pressure and temperature
                    conditions.{" "}
                  </p>
                </div>
