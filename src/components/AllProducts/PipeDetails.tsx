...
const PipeFittingDetails = () => {
  const productSlideImages = [
    "/allProductsImg/pipes/pipe1.webp",
    "/allProductsImg/pipes/pipe2.webp",
    "/allProductsImg/pipes/pipe3.webp",
    // "/allProductsImg/pipes/pipe4.webp",
    // "/allProductsImg/pipes/pipe5.webp",
  ];
              ...
              <div className=" leading-[1.05] max-lg:w-full max-lg:mt-8 ">
                <div className="">
                  ...
                  <p className="text-gray-600 content-all text-sm">
                    Our Pipe Fittings comply with standards such as ASME B16.11,
                    MSS-SP-83, and BS 3799, ensuring durability and
                    compatibility in piping systems. Sizes range from 1/8 inch
                    to 4 inches, and materials include stainless steel, carbon
                    steel, and alloy steel per ASTM A105, ASTM A182, and ASTM
                    A234. These fittings are suitable for oil and gas pipelines,
                    chemical processing plants, and industrial water systems,
...
export default PipeFittingDetails;
