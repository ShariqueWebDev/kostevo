...
const GearsDetails = () => {
  const productSlideImages = [
    "/allProductsImg/gears/gear1.webp",
    "/allProductsImg/gears/gear2.webp",
    "/allProductsImg/gears/gear3.webp",
    // "/allProductsImg/gears/gear4.webp",
    // "/allProductsImg/gears/gear5.webp",
  ];
              ...
              <div className=" leading-[1.05] max-lg:w-full max-lg:mt-8 ">
                <div className="">
                  ...
                  <p className="text-gray-600 content-all text-sm">
                    Our custom-manufactured Gears adhere to standards such as
                    AGMA and DIN 3962, ensuring precision and optimal
                    performance in mechanical power transmission. Using
                    materials like alloy steel and stainless steel per ASTM A291
                    and ASTM A322, we produce spur gears, helical gears, bevel
                    gears, and worm gears up to 1,000 mm in diameter. These
                    gears are suitable for heavy machinery, automotive
                    transmissions, industrial equipment, and precision
                    instruments requiring accurate motion control.{" "}
                  </p>
                </div>
